...
namespace InsuranceApi.Application {
    public class ProposalContractApplication : IProposalContractApplication {
        ...
        public ProposalContractApplication(IProposalApplication proposalApplication, IInsuredService insuredService, IInsuredApplication insuredApplication,
        ...
        public async Task<ProposalReturnGravarEntity> AddAsync(ProposalContractEntity entity, int brokerUserId) {
            try {
