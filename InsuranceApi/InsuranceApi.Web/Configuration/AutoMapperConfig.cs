...
namespace InsuranceApi.Web.Configuration {
    public class AutoMapperConfig : Profile {
        public AutoMapperConfig() {
            ...
            CreateMap<ProposalSignatureViewModel, ProposalSignatureEntity>().ReverseMap();
            CreateMap<DocumentViewModel, DocumentEntity>().ReverseMap();
            CreateMap<TakerModel, TakerReturnViewModel>().ReverseMap();
            CreateMap<CivilCourtEntity, CivilCourtReturnViewModel>().ReverseMap();
            CreateMap<CivilCourtEntity, CivilCourtReturnViewModel>().ReverseMap();
            ...
            CreateMap<ProposalBiddingViewModel, ProposalBiddingEntity>().ReverseMap();
