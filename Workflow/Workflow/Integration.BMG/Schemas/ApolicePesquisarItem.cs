...
namespace Integration.BMG.Schemas {
    public class ApolicePesquisarItem {
        ...
        public string dados_garantia_vl_premio_net { get; set; }
        ...
        public string dv_premio_calculo_manual { get; set; }
        public string cd_usuario_altracao { get; set; }
        public string nm_usuario_alteracao_login { get; set; }
        public List<ApolicePesquisarParcelaItem> Parcelas_Pesquisar { get; set; }
