...
namespace Application.Interfaces.Services {
    public interface IComissionStatementService {
        ...
        IList<ComissionStatementDetail> ListComissionStatementDetais(int statementNumber, string competency, string brokerLegacyCode, string brokerSusepCode, int brokerUserId, int LoggedUserId);
