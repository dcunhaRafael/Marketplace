...
insert into ComissionStatementStatus(Name, LegacyCode, BackgroundColor, TextColor, Status, InclusionUserId, InclusionDate) values ('Pendente', '131', '#fcff33', '#000000', 1, 1, getdate());
insert into ComissionStatementStatus(Name, LegacyCode, BackgroundColor, TextColor, Status, InclusionUserId, InclusionDate) values ('Confirmado', '132', '#0000FF', '#FFFFFF', 1, 1, getdate());
insert into ComissionStatementStatus(Name, LegacyCode, BackgroundColor, TextColor, Status, InclusionUserId, InclusionDate) values ('Cancelado', '133', '#FF0000', '#FFFFFF', 1, 1, getdate());
insert into ComissionStatementStatus(Name, LegacyCode, BackgroundColor, TextColor, Status, InclusionUserId, InclusionDate) values ('Liberado', '134', '#00FF00', '#FFFFFF', 1, 1, getdate());
insert into ComissionStatementStatus(Name, LegacyCode, BackgroundColor, TextColor, Status, InclusionUserId, InclusionDate) values ('Transferido', '136', '#1ED5C2', '#FFFFFF', 1, 1, getdate());
insert into ComissionStatementStatus(Name, LegacyCode, BackgroundColor, TextColor, Status, InclusionUserId, InclusionDate) values ('Rejeitado', '135', '#FF0000', '#FFFFFF', 1, 1, getdate());
insert into ComissionStatementStatus(Name, LegacyCode, BackgroundColor, TextColor, Status, InclusionUserId, InclusionDate) values ('Em análise', '130', '#000000', '#FFFFFF', 1, 1, getdate());
insert into ComissionStatementStatus(Name, LegacyCode, BackgroundColor, TextColor, Status, InclusionUserId, InclusionDate) values ('Reagendado', '137', '#c7ca16', '#000000', 1, 1, getdate());
